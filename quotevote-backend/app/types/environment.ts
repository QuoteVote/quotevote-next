...
export function parseEnvironmentConfig(env: NodeJS.ProcessEnv): EnvironmentConfig {
  ...
  return {
    ...
    graphql: {
      ...
      playgroundEnabled: parseBoolean(env.GRAPHQL_PLAYGROUND_ENABLED, env.NODE_ENV !== 'production'),
    },
    ...
    email: env.SMTP_HOST || env.SENDGRID_API_KEY ? {
      smtp: env.SMTP_HOST ? {
        host: env.SMTP_HOST,
    ...
    monitoring: env.SENTRY_DSN || env.GOOGLE_ANALYTICS_ID ? {
